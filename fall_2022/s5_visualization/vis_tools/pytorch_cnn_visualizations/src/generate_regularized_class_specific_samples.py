...
class RegularizedClassSpecificImageGeneration:
    ...
    def generate(
        self, iterations=150, blur_freq=4, blur_rad=1, wd=0.0001, clipping_value=0.1
    ):
        ...
        for i in range(1, iterations):
            ...
            optimizer = SGD(
                [self.processed_image], lr=initial_learning_rate, weight_decay=wd
            )
            # Forward
        ...
        os.rename(
            f"../generated/class_{self.target_class}",
